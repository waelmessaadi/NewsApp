...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AccompanistLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>coil</b> with <b>com.google.accompanist:accompanist-coil</b> coordinates and
         * with version reference <b>accompanistCoil</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCoil() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("accompanist.coil");
        }
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>hiltCompiler</b> with <b>androidx.hilt:hilt-compiler</b> coordinates and
    ...
    public static class DaggerLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>hiltTesting</b> with <b>com.google.dagger:hilt-android-testing</b> coordinates and
         * with version reference <b>hilt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getHiltTesting() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("dagger.hiltTesting");
        }
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutinesAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kotlin.coroutinesAndroid");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutinesCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kotlin.coroutinesCore");
        }
    ...
    public static class MaterialIconsLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>iconExtended</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class MockitoJunitLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>mockitoJupiter</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistCoil</b> with value <b>0.7.0</b>
         * <p>
         ...
         */
        public Provider<String> getAccompanistCoil() { return getVersion("accompanistCoil"); }
        ...
        /**
         * Version alias <b>coilCompose</b> with value <b>3.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>iconExtended</b> with value <b>1.7.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIconExtended() { return getVersion("iconExtended"); }
        ...
        /**
         * Version alias <b>jupiter</b> with value <b>5.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinTest</b> with value <b>1.5.21</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockitoJupiter</b> with value <b>4.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMockitoJupiter() { return getVersion("mockitoJupiter"); }
    ...
    public static class HiltGradlePluginAccessors extends PluginFactory {
        private final HiltGradleHiltPluginAccessors paccForHiltGradleHiltPluginAccessors = new HiltGradleHiltPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.hilt.gradle.hilt</b>
         */
        public HiltGradleHiltPluginAccessors getHilt() {
            return paccForHiltGradleHiltPluginAccessors;
        }

    }

    public static class HiltGradleHiltPluginAccessors extends PluginFactory {

        public HiltGradleHiltPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>hilt.gradle.hilt.testing</b> with plugin id <b>com.google.dagger.hilt.android.testing</b> and
         * with version reference <b>hilt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getTesting() { return createPlugin("hilt.gradle.hilt.testing"); }
